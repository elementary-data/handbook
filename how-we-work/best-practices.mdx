...
This is pretty straight forward - we set goals, we experiment and try to make an impact, we leverage data to understand what worked and what didn’t. We actively think about what data we new need to answer our questions, and which new learnings we can produce from it.
