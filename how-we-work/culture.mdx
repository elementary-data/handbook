...
The process of building Elementary is similar for both product and company. Each one of us is responsible to implement this principles in day to day, demand and help others to do so as well.


### Extreme ownership

Building Elementary is a team effort. However, each team member can have a major impact on our success, and we measure your personal performance accordingly. In a sense, we expect each of you to think of yourself as if you are solely responsible to achieve our goals.
...
You have full ownership on your work, pick the very most impactful tasks and communicate to the team how they can help you succeed. As long as you do that, we will never limit you.
...
We expect you to focus on what makes the most impact. The best way to achieve that is to provide you the full context. You have to understand the big picture, and get access to all details. We believe that this is the best way to empower people to make right decisions.

This is also the best way to create alignment in the team. To work well together, we can’t afford information gaps. This means that everything is public and shared by default. The only exceptions are personal private issues and matters that can put the company at risk.
...
We are constantly learning and adapting, we must be open-minded. People are naturally intimidated by changes, but in a startup - we must fear stagnation and embrace changes. It sounds scary at first, but this is actually what makes us confident. As long as we respond fast and adapt - we are on the right track.
