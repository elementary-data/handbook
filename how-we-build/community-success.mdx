...
Every day someone from the team is on call as what we call ‘community success’.
...
- See the schedule here.
    - [https://elementary-data.pagerduty.com/schedules#PZFSKWF](https://elementary-data.pagerduty.com/schedules#PZFSKWF)
- Or - type `/pd oncall` on Slack.

### What should I do during non-working hours?

- Try to provide at least an initial reply.
    - If you can reply and help, that’s great. If not, don’t feel bad about it. Simply do the following -
...
- Ask the team if someone is familiar with it and can help.
- Tell the user that you are asking internally if someone from the team can help with it as your are less familiar with this part of the system (it shows the users that we are handling it and it’s not stalling).
